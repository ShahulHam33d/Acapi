...
-- CreateEnum
CREATE TYPE "ConversationStatus" AS ENUM ('REQUESTING', 'ACTIVE', 'CLOSED');
...
CREATE TABLE "Conversation" (
    ...
    "status" "ConversationStatus" NOT NULL DEFAULT 'REQUESTING',
    "assignedUserId" TEXT,
    "intervenedByUserId" TEXT,
    "intervenedAt" TIMESTAMP(3),
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_intervenedByUserId_fkey" FOREIGN KEY ("intervenedByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
